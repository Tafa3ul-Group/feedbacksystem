  ...
  <div>
    ...
    <Transition enter-active-class="transition-all duration-300 ease-out"
      ...
      <div v-if="isExpanded" ref="widgetRef"
        class="fixed z-50 w-80 max-w-[calc(100vw-32px)] bg-white/90 backdrop-blur-xl shadow-2xl rounded-2xl border border-gray-200/50 dark:bg-gray-900/90 dark:border-gray-700/50 select-none transition-all duration-300 hover:shadow-3xl dark:hover:shadow-gray-900/50 bottom-20 right-4"
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200/50 dark:border-gray-700/50">
          <div class="flex items-center gap-3">
            <div
              ...
              <svg width="28" height="28" viewBox="0 0 263 244" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
